...
install -Dm0755 "$DISTRO/packages/cloudless-shell/cloudless-display-watch" "$PKG/usr/bin/cloudless-display-watch"
install -Dm0755 "$DISTRO/packages/cloudless-shell/cloudless-wait-for-display" "$PKG/usr/lib/cloudless/cloudless-wait-for-display"
install -Dm0644 "$DISTRO/packages/cloudless-shell/lightdm-wait-display.conf" "$PKG/lib/systemd/system/lightdm.service.d/60-cloudless-wait-display.conf"
