...
! grep -Fq 'docker run --rm -it' "$ROOT/distro/scripts/sign-release-interactive.sh"
! grep -Fq 'GPG_TTY=' "$ROOT/distro/scripts/sign-release-interactive.sh"
...
grep -Fq 'verify-release-container-platforms.sh' "$release"
...
grep -Fq 'test-release-container-platforms.sh' "$runner"
...
grep -Fq 'test-protected-signing.sh' "$runner"
