...
grep -Fq 'test-configure-release-env.sh' "$release"
grep -Fq 'test-security-readiness.py' "$release"
grep -Fq 'test-ci-qualification.py' "$release"
...
grep -Fq 'python3 distro/scripts/test-security-readiness.py' "$workflow"
grep -Fq 'python3 distro/scripts/test-ci-qualification.py' "$workflow"
grep -Fq 'bash distro/scripts/test-configure-release-env.sh' "$workflow"
...
grep -Fq 'prepare-ci-qualification.py' "$release"
